<template>
  <div ref="containerRef" class="relative">
    <button
      class="inline-flex items-center justify-center p-3 rounded-lg text-sm font-medium text-foreground hover:text-foreground hover:bg-background-secondary transition-colors"
      @click="isOpen = !isOpen"
    >
