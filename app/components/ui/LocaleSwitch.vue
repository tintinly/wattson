<template>
  <div ref="containerRef" class="relative">
    <button
      class="inline-flex items-center justify-center px-2 py-1.5 rounded-lg text-sm font-medium text-foreground-secondary hover:text-foreground hover:bg-background-secondary transition-colors"
      @click="isOpen = !isOpen"
    >
